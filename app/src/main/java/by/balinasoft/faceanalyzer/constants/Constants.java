package by.balinasoft.faceanalyzer.constants;
...
public class Constants {
    ...
    public static final String FACE_PROPERTIES_NAME = "name";

    public static final String FACE_PROPERTIES_VALUE = "value";
